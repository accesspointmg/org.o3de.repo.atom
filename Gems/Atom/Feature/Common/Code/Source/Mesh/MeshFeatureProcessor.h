...
namespace AZ
{
    namespace Render
    {
        ...
        public:
            ...
            const RHI::Ptr<MeshInfoEntry> GetMeshInfoEntry(const MeshInfoHandle handle) override;
            ...
            const RHI::Ptr<FallbackPBR::MaterialEntry> GetFallbackPBRMaterialEntry(const MeshInfoHandle handle) override;
