...
namespace AZ
{
    namespace Render
    {
        ...
        const RHI::Ptr<MeshInfoEntry> MeshFeatureProcessor::GetMeshInfoEntry(const MeshInfoHandle handle)
        {
        ...
        const RHI::Ptr<FallbackPBR::MaterialEntry> MeshFeatureProcessor::GetFallbackPBRMaterialEntry(const MeshInfoHandle handle)
        {
